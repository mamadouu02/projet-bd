...
public class Refuge{
    ...
    void TestReservationRefuge(Connection conn,String mail_refuge,Date res) {
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement
                    ("select date_ouverture,date fermeture from Refuge where mail_refuge = ? ");
    ...
    void InsertReserveRefuge(Connection conn,int userid,String mail,String Heure,Date date,int nb_nuit,int nb_repas
    ,int prix_res_refuge){
        try {
