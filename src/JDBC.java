...
public class JDBC {
    ...
    public void textReservMat() {
        ...
        while (!cmd.equals("exit")) {
            ...
            getCmd();
            int anneeAchat = Integer.parseInt(cmd);
    ...
    public void parcoursMateriels() {
        String afficheMaterielActivite = "SELECT l.marque, l.modele, l.nb_pieces_lot, l.nb_pieces_lot - SUM(qm.nb_pieces_perdues) - SUM(qm.nb_pieces_res) AS nb_pieces_disponibles " +
                "FROM lot l " +
